                 ...
                 <table id="category_table" border="1" class="responsive-table striped stock_table">
                     ...
                     @foreach($categories as $category)
                         <tr class="none-top-border">
                             ...
                             <td>{{$category->name}}</td>
                             <td class="btn_info">
                                 <a id="{{$category->id}}" href="#"  data-target="modal1" class="btn btn-floating waves-effect waves-light blue action_button tooltipped edit_category_trigger" data-tooltip="Edit Category" data-position="top"><span class="fa fa-pencil"></span></a>
     ...
     <div class="col s6 m6 lg6">
         ...
         <div class="card-panel large ">
             ...
             <div class="card-content">
                 ...
                 <table id="brand_table" border="1" class="responsive-table striped stock_table">
                     ...
                     @foreach($brands as $brand)
                         <tr class="none-top-border">
                             ...
                             <td>{{$brand->info}}</td>
                             <td class="btn_info">
                                 <a id="{{$brand->id}}" href="#editBrandModal"  data-target="modal1" class="btn btn-floating waves-effect waves-light blue action_button tooltipped edit_brand_trigger" data-tooltip="Edit Brand" data-position="top"><span class="fa fa-pencil"></span></a>
                                 <a id="{{$brand->id}}" href="#deleteProductModal" class="btn btn-floating tooltipped waves-effect waves-light red action_button tooltipped delete_brand_trigger" data-tooltip="Delete Brand" data-position="top"><span class="fa fa-trash"></span></a>
                             </td>
                         </tr>
                     @endforeach
                     </tbody>
